...
CREATE
OR REPLACE FUNCTION get_info_by_username(user_name TEXT)
...
CREATE
OR REPLACE FUNCTION get_amount_of_nravlicks_by_audio_id(_audio_id INTEGER)
    RETURNS INTEGER AS
$$
DECLARE
result INTEGER;
...
CREATE
OR REPLACE FUNCTION get_all_audios_by_author_name(author_name TEXT)
...
CREATE
OR REPLACE FUNCTION get_all_emotions_by_audio_id(_audio_id INTEGER)
    RETURNS TABLE
            (
                username_id         INTEGER,
                username            VARCHAR(32),
...
CREATE
OR REPLACE FUNCTION get_all_posts_by_profile_id(_profile_id INTEGER)
...
CREATE
OR REPLACE FUNCTION get_comments_by_post_id(_post_id INTEGER)
    RETURNS TABLE
            (
...
CREATE
OR REPLACE FUNCTION get_all_audios_from_playlist_by_playlist_id(_playlist_id INTEGER)
    RETURNS TABLE
            (
...
CREATE
OR REPLACE FUNCTION get_audio_info_by_audio_id(_audio_id INTEGER)
    RETURNS TABLE
            (
                authors     TEXT,
                audio_name  VARCHAR(32),
...
CREATE
OR REPLACE FUNCTION get_all_audios_by_genre(genre_name TEXT)
    RETURNS TABLE
            (
                audio_id          INT,
                audio_name        VARCHAR(32),
...
CREATE
OR REPLACE FUNCTION get_achievements_by_username(user_name TEXT)
...
CREATE
OR REPLACE FUNCTION get_all_save_audio_by_username(user_name TEXT)
    RETURNS SETOF audio AS
$$
BEGIN
RETURN QUERY SELECT a.id, a.name, a.text, a.upload_date
...
CREATE
OR REPLACE FUNCTION get_all_followers_by_username(user_name TEXT)
    RETURNS SETOF person AS
$$
BEGIN
...
CREATE
OR REPLACE FUNCTION get_all_subscriptions_by_username(user_name TEXT)
    RETURNS SETOF person AS
$$
BEGIN
RETURN QUERY SELECT p.id, p.username
...
CREATE
OR REPLACE FUNCTION get_balance_by_username(user_name TEXT)
    RETURNS INTEGER AS
$$
DECLARE
balance INTEGER;
...
CREATE
OR REPLACE FUNCTION get_roles_by_username(user_name TEXT)
    RETURNS TEXT AS
$$
DECLARE
returning_role TEXT;
...
CREATE
OR REPLACE FUNCTION get_achievement_progress_by_name_and_username(_name TEXT, user_name TEXT)
    RETURNS INTEGER AS
$$
BEGIN
RETURN QUERY
...
CREATE
OR REPLACE FUNCTION get_audio_by_name(audio_name TEXT)
    RETURNS SETOF audio AS
$$
BEGIN
RETURN QUERY
...
CREATE
OR REPLACE FUNCTION get_playlists_by_name(playlist_name TEXT)
...
CREATE
OR REPLACE FUNCTION get_audio_by_author_name(author_name TEXT)
    RETURNS SETOF audio AS
$$
BEGIN
RETURN QUERY
...
CREATE
OR REPLACE FUNCTION get_persons_by_username(user_name TEXT)
    RETURNS SETOF person AS
$$
BEGIN
RETURN QUERY
